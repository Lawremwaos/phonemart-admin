...
import { downloadReceiptAsPDF, downloadReceiptAsPrint, shareViaWhatsApp, shareViaEmail, formatReceiptText } from "../utils/receiptUtils";
...
export default function ReceiptView() {
  ...
  if (!sale) {
    return (
      <div className="pm-card pm-pad-xl text-center">
        <p className="text-gray-600">No receipt data found.</p>
        <button
  ...
  const handlePrint = () => {
    if (receiptRef.current) {
      downloadReceiptAsPrint(receiptRef.current);
    }
  };
    ...
    <div className="p-6">
      <div className="pm-page-head mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
          <h2 className="text-2xl font-bold text-[var(--pm-ink)]">Digital Receipt</h2>
          <div className="flex flex-wrap gap-2">
            <div className="flex items-center gap-2">
              <input
                ...
                className="pm-input text-sm min-w-[220px]"
            ...
            <button
              ...
              className="pm-btn pm-btn-success flex items-center gap-2"
            >
